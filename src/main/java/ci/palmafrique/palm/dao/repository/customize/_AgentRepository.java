...
/**
 * Repository customize : Agent.
 */
@Repository
public interface _AgentRepository {
	default List<String> _generateCriteria(AgentDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
