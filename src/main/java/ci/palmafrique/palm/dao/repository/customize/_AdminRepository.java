...
/**
 * Repository customize : Admin.
 */
@Repository
public interface _AdminRepository {
	default List<String> _generateCriteria(AdminDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
