...
/**
 * Repository customize : Absence.
 */
@Repository
public interface _AbsenceRepository {
	default List<String> _generateCriteria(AbsenceDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
