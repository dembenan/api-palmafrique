...
/**
 * Repository customize : Medecin.
 */
@Repository
public interface _MedecinRepository {
	default List<String> _generateCriteria(MedecinDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
