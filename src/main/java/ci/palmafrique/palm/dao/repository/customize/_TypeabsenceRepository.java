...
/**
 * Repository customize : Typeabsence.
 */
@Repository
public interface _TypeabsenceRepository {
	default List<String> _generateCriteria(TypeabsenceDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
